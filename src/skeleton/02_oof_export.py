...
OUT_DIR = Path("/kaggle/working/skeleton_cross_subject")
SUBMISSION_PATH = Path("/kaggle/working/submission.csv")
# Quality auditing needs only five-fold held-out predictions. Keep this True to
# skip test extraction and the two full-data models after OOF has been written.
AUDIT_ONLY = True
...
def main():
    ...
    oof_path = analysis / "oof_best_baseline.csv"
