...
class Config:
    ...
    @property
    def out_dir(self):
        return self.work_root / "thermal_v16_mvitv2s_maskfeat_160_v11_finetune"
...
FINAL_MODEL = CFG.out_dir / "thermal_v16_mvitv2s_maskfeat_160_v11_finetune_int8.pt"
torch.save({
    "model_int8": packed,
    "architecture": "torchvision_mvit_v2_s_relative_position_32x160",
    ...
    "experiment_hypothesis": "higher native spatial sampling with unchanged 2x32x32-pixel HOG target physics",
